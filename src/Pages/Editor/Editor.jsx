...
const Editor = ({ setFormId, setFormStatus }) => {
    ...
    try {
      ...
      // post methods 
        if (result.isConfirmed) {
          fetch("https://form-builder-server-smoky.vercel.app/form", {
            method: "POST",
  ...
  return (
    <div>
      <h1 className="text-xl md:text-4xl font-bold text-center my-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-11">
            {numOfMcqQuestions.map((num, index) => {
              return (
                <div
                  key={index}
                  className="mt-10 bg-gray-300 p-3 md:p-9 rounded-lg"
                >
